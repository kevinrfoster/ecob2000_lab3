...
We'll split into groups. You get the rest of the class to prepare and will write up results in homework. I had posted a video of the lecture already.
...
Start with looking at the differences in means of some of the variables and put that together with your own knowledge of the city. You might want to subset the data -- are you trying to predict everbody? Are young people easier? Retirees? College grads? The work you did for Lab 2 should come in handy now.
